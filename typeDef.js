...
const typeDefs= gql`
    ...
    type Mutation{
        ...
        UpdateRecipe(id:ID,recipe_name:String,price:Int,status:status_recipe,description:String,image:String,menu_highlight:Boolean,special_offers:Boolean,discount:Int,ingredients:[ingredientidinput]):recipes
